...
(cl:defmethod cl:initialize-instance :after ((m <Pos_XYZ_th>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pos_XYZ_th)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_pkg-msg:<Pos_XYZ_th> is deprecated: use dji_pkg-msg:Pos_XYZ_th instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Pos_XYZ_th>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_pkg-msg:x-val is deprecated.  Use dji_pkg-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Pos_XYZ_th>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_pkg-msg:y-val is deprecated.  Use dji_pkg-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Pos_XYZ_th>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_pkg-msg:z-val is deprecated.  Use dji_pkg-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'th-val :lambda-list '(m))
(cl:defmethod th-val ((m <Pos_XYZ_th>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_pkg-msg:th-val is deprecated.  Use dji_pkg-msg:th instead.")
  (th m))
